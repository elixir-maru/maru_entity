defmodule Maru.EntityTest do
  ...
  describe "present" do
    test "returns single object" do
      ...
      assert PostEntity.serialize(post) == %{
               id: 1,
               title: "My title",
               content: "This is a <b>html body</b>"
             }
    end
    ...
    test "returns multiple objects" do
      ...
      expected = [
        %{id: 1, title: "My title", content: "This is a <b>html body</b>"},
    ...
    test "serializes stuff using with" do
      ...
      expected = %{
        body: "<b>comment body</b>",
        post: %{id: 2, title: "My other title", content: "<b>html body</b>"},
        nested: %{rename: "<b>comment body</b>"}
      }
    ...
    test "serializes array using with" do
      ...
      expected = %{
        ...
        post_count: 2,
        posts: [
          %{id: 1, title: "My other title", content: "<b>html body</b>"},
    ...
    test "does not show post if nil " do
      ...
      assert IfCommentEntity.serialize(comment2) == %{
               body: "body",
               post: %{id: 3, title: "asdf", content: "a"}
             }
    end
    ...
    test "does not show post unless present " do
      ...
      assert UnlessCommentEntity.serialize(comment2) == %{
               body: "body",
               post: %{id: 3, title: "asdf", content: "a"}
             }
    end
    ...
    test "batch helper for list of objects" do
      ...
      assert [
               ...
               %{
                 id: 110,
                 author: [
                   %{id: 3, name: "Author1_3", option: 1},
                   %{id: 3, name: "Author2_3", option: 1}
                 ]
               },
               %{
                 id: 130,
                 author: [
                   %{id: 7, name: "Author1_7", option: 1},
                   %{id: 7, name: "Author2_7", option: 1}
                 ]
               }
  ...
  describe "test alias" do
    ...
    test "alias in do_function" do
      assert AliasTestEntity.serialize(%{}) == %{
               alias_test: %Maru.EntityTest.StructTest.AliasTest{alias_test: true}
             }
    end
  end
  ...
  describe "before serialize" do
    ...
    test "before serialize nested" do
      assert %{foo: "12", bar: [%{bar: 104}, %{bar: 107}]} =
               BeforeSerializeNestedTest.serialize(
                 %{foo: %{foo: 1}, bar: [%{bar: 3}, %{bar: 6}]},
                 %{bar: 10, baz: 100}
               )
    end
  ...
  describe "erorr handler" do
    ...
    test "one field" do
      assert %{group: %{id: 900_303}} == ErrorHandlerOneTest.serialize(%{id: 1})
    end
